...
export interface ApiListingListing extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A car advert ingested from a Source. Test schema for a 100-ad sample; not the final domain model.';
    displayName: 'Listing';
    pluralName: 'listings';
  ...
  attributes: {
    ...
    engineDisplacementCc: Schema.Attribute.Integer;
    enginePowerHp: Schema.Attribute.Integer;
    ...
    source: Schema.Attribute.Enumeration<['publi24', 'olx']> &
      Schema.Attribute.Required;
